...
def parseTime(time):
    # 1:30am today
    # 2:30pm tomorrow ....
    numberTime = time.split(" ")[0]  # time
    day = time.split(" ")[1]  # today or tomorrow
    hour = numberTime[len(numberTime)-2:]  # am or pm
...
class Reminder:
    ...
    # update the reminder 
    # delete the reminder 
    # add notification for your own os 
